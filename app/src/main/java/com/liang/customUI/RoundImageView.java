...
public class RoundImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		// 淇濊瘉閲嶆柊璇诲彇鍥剧墖鍚庝笉浼氬洜涓哄浘鐗囧ぇ灏忚?屾敼鍙樻帶浠跺銆侀珮鐨勫ぇ灏忥紙閽堝瀹姐?侀珮涓簑rap_content甯冨眬鐨刬mageview锛屼絾浼氬鑷磎argin鏃犳晥锛?
	...
	public Bitmap getCroppedRoundBitmap(Bitmap bmp, int radius) {
		...
		// bitmap鍥炴敹(recycle瀵艰嚧鍦ㄥ竷灞?鏂囦欢XML鐪嬩笉鍒版晥鏋?)
		// bmp.recycle();
